	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div
					style="display: flex; align-items: center; padding-top: 0px; padding-bottom: 0px; padding-left: 30px; padding-right: 30px">
